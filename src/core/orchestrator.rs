...
impl Orchestrator {
    ...
    pub fn new(config: ObfuscatorConfig) -> Self {
        ...
        let total_techniques = crate::TOTAL_TECHNIQUES;
...
mod tests {
    ...
    fn test_orchestrator_creation() {
        ...
        assert_eq!(orch.total_techniques(), crate::TOTAL_TECHNIQUES);
    }
    ...
    fn test_enabled_techniques_count() {
        ...
        let orch = Orchestrator::new(config);
        assert_eq!(orch.enabled_techniques_count(), crate::TOTAL_TECHNIQUES);
    }
